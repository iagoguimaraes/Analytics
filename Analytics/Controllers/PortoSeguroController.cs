...
namespace Analytics.Controllers
{
    ...
    public class PortoSeguroController : ApiController
    {
        ...
        public HttpResponseMessage DashboardComparativo(FormDataCollection form)
        {
            try
            {
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    parametros.Add("carteiras", carteira);
                    parametros.Add("carteiras_2", carteira_2);
        ...
        [Route("dashboard/digital/vida/pagamento")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardPagamentoVida(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_pagamento_vida", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/vida/efetividade")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardEfetividadeVida(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_efetividade_vida", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/residencial/promessa")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardPromessaResidencial(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_promessa_residencial", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/residencial/pagamento")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardPagamentoResidencial(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_pagamento_residencial", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/residencial/efetividade")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardEfetividadeResidencial(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_efetividade_residencial", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/azul/horahora")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardHoraHoraAzul(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
        ...
        [Route("dashboard/digital/azul/producao")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardProducaoAzul(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
        ...
        [Route("dashboard/digital/azul/promessa")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardPromessaAzul(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_promessa_azul", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/azul/efetividade")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardEfetividadeAzul(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_efetividade_azul", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/consorcio/horahora")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardHoraHoraConsorcio(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_horahora_consorcio", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/consorcio/producao")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardProducaoConsorcio(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_producao_consorcio", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/consorcio/promessa")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardPromessaConsorcio(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_promessa_consorcio", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/consorcio/pagamento")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardPagamentoConsorcio(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_pagamento_consorcio", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
        ...
        [Route("dashboard/digital/consorcio/efetividade")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardEfetividadeConsorcio(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_PORTO"))
                {
                    ...
                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_efetividade_consorcio", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
