...
namespace Analytics.Controllers
{
    ...
    public class TimController : ApiController
    {
        ...
        [Route("dashboard/voxage/horahora")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardVoxageHoraHora(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
        ...
        [Route("dashboard/voxage/producao")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardVoxageProducao(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
        ...
        [Route("dashboard/voxage/acionamento")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage AcionamentoVoxAgeDigital(FormDataCollection form)
        {
        ...
        [Route("dashboard/voxage/download")]
        [HttpPost]
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DownloadExcelVoxAgeDigital(FormDataCollection form)
        {
