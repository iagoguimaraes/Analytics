...
namespace Analytics.Controllers
{
    ...
    public class RHController : ApiController
    {
        ...
        public HttpResponseMessage DashboardFiltros()
        {
            try
            {
                using (SqlHelper sql = new SqlHelper("CUBO_RH"))
                {
        ...
        [Autorizar]
        [Gravar]
        public HttpResponseMessage DashboardHeadCount(FormDataCollection form)
        {
            try
            {
                DateTime dtini = Convert.ToDateTime(form["dtini"]);
                DateTime dtfim = Convert.ToDateTime(form["dtfim"]);
                DataTable departamentos = JsonConvert.DeserializeObject<DataTable>(form["departamentos"]);
                ...
                using (SqlHelper sql = new SqlHelper("CUBO_RH"))
                {
                    ...
                    parametros.Add("departamentos", departamentos);

                    DataSet resultado = sql.ExecuteProcedureDataSet("sp_dashboard_headcount", parametros);
                    return Request.CreateResponse(HttpStatusCode.OK, resultado);
                }
            }
            catch (Exception e)
